...
steps:
  ...
  schizophrenia-spectrum-xschizophreniform---primary:
    run: schizophrenia-spectrum-xschizophreniform---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  persistent-schizophrenia-spectrum---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: schizophrenia-spectrum-xschizophreniform---primary/output
